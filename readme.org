...
original implementation (different rounding of floats, a catched bug
in adding words,... ). Nevertheless, this might be a very helpful tool
for any system administrator or first responder.
